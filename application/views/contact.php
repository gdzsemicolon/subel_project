 ...
 * Contact class.
 * @author Semi Colon Team.
 * Description : This class for showing company Contact information.
 * 
 */
...
<div id="contents">
    <div id="x">
        <div class="clearfix">
            <iframe src="https://www.google.com/maps/d/embed?mid=z5iSSwasTPcw.k2zhSMB_2uTY" width="500" height="420"></iframe>
        </div>
    </div>
    <div class="highlight">
        <div class="clearfix">
            ...
            <h3> Subel Turizm Sanayi ve Ticaret Limited Sirketi</h3>
            <p>
                <b>Adres :</b> Yeni Mahalle Hasan Şen Sokak No:6/3 Susurluk Balıkesir 
                <br><BR>
                ...
                <br><BR>
                <b>Banka IBAN :</b> 
                TR 69 0001 2009 2480 0010 2601 28
                <br><BR>
                <b>Telefon :</b> 0 (266) 865 40 80

                <b>Fax : </b>0 (266) 865 40 80
            </p>
